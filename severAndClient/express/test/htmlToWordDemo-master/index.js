...
<!-- 使用jsFiddle生成Word -->
	...
	result.addEventListener('click', function(){
		...
		console.dir($("#id1"));
		var $table1=$("#id1");
		$div.append($homeTitle, $homeInfo, $homeFooter, $firstPointTitle, $firstPointFirPara, $firstPointFirImg, $firstPointSecPara, $firstPointSecImg, $secondPointTitle, $resultTable,$table1);
