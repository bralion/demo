            ...
            <el-table
                ...
                <el-table-column
                    ...
                    <template slot-scope="scope">
                        <div class="statusBtn statusBtn-success" v-if="scope.row.status==='normal'"><span class="normal"></span>已推送</div>
                        <div class="statusBtn statusBtn-warning" v-if="scope.row.status==='pause'"><span class="pause"></span>未推送</div>
                    </template>
                </el-table-column>
                <el-table-column
                        align="center"
                ...
                <el-table-column
                    ...
                    <template slot-scope="scope">
                        <span class="btn">
                            <i title="编辑"  @click="handleEdit(scope.row)"style="cursor: pointer;">推送</i>
                        </span>
                    </template>
